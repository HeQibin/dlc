...
def parse_args():
    ...
    parser.add_argument(
        '--dataset_path', 
        default="/map-hl/qibin.he/data/rs/vaihingen",
...
def main():
    ...
    out_dir = osp.join(out_dir, f"irrg_{args.clip_size}_s{args.stride_size}")
    ...
    label_dir = osp.join(args.dataset_path, "gt")
    img_dir = osp.join(args.dataset_path, "top")
...
if __name__ == '__main__':
    ...
    clip_dir = "/map-hl/qibin.he/data/rs/vaihingen/irrg_512_s256/img_dir/train"
    label_dir = "/map-hl/qibin.he/data/rs/vaihingen/irrg_512_s256/ann_dir/train"
    out_dir = "/map-hl/qibin.he/data/rs/vaihingen/irrg_512_s256/vis_dir/train"
