...
class HRDAHeadWithNTM(BaseDecodeHead):
    ...
    def __init__(self,
        ...
        super(HRDAHeadWithNTM, self).__init__(**kwargs)
        del self.conv_seg
        del self.dropout
    ...
    def losses(self, seg_logit, seg_label, seg_weight=None, target_domain=False):
        ...
        loss = self.single_losses(fused_seg, seg_label, seg_weight, target_domain=target_domain)
    ...
    def single_losses(self, seg_logit, seg_label, seg_weight=None, target_domain=False):
